...
describe('SignUpPage', () => {
    ...
    // test('handles sign up with valid data', async () => {
    ...
    //     await waitFor(() => {
    //         expect(axios.post).toHaveBeenCalledWith(
    //             'https://fixercapstone-production.up.railway.app/client/register',
    //             {
    ...
    //     fireEvent.changeText(getByPlaceholderText('Email'), 'valid12@gamil.com');
    //     fireEvent.changeText(getByPlaceholderText('Password'), 'Password1!');
    //     fireEvent.changeText(getByPlaceholderText('Confirm Password'), 'Password1!');
    //     fireEvent.press(getByText('Next'));
    //     fireEvent.changeText(getByPlaceholderText('First Name'), 'John');
    //     fireEvent.changeText(getByPlaceholderText('Last Name'), 'Doe');
    //     fireEvent.changeText(getByPlaceholderText('House Number and Street'), '1550 De Maisonneuve');
    //     fireEvent.changeText(getByPlaceholderText('Postal Code'), 'H3G 1M8');
    //     fireEvent.press(getByText('Verify Address'));
    //     // expect(getByText("Valid Address entered")).toBeTruthy();
    //     fireEvent.press(getByTestId('sign-up-button'));
