...
const { profile, authenticateJWT, addBankingInfo, getBankingInfoStatus, getPaymentMethod, updateProfessionalProfile} = require('../controller/professionalClientProfile');
...
const { forgotPassword, resetPassword, validateCurrentPassword, updatePassword } = require('../controller/resetController');
...
professionalRouter.post('/reset/validateCurrentPassword', validateCurrentPassword);
