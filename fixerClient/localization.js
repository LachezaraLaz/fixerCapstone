const en = {
    ...
    no_requests_available: "No offers available.",
    success: "Success",
    offer_accepted: "Offer accepted successfully.",
    offer_rejected: "Offer rejected successfully.",
    failed_to_accept_offer: "Failed to accept the offer.",
    failed_to_reject_offer: "Failed to reject the offer.",
    error_accepting_offer: "An error occurred while accepting the offer.",
    error_rejecting_offer: "An error occurred while rejecting the offer.",
...
const fr = {
    ...
    no_requests_available: "Aucune offre disponible.",
    success: "Succès",
    offer_accepted: "Offre acceptée avec succès.",
    offer_rejected: "Offre refusée avec succès.",
    failed_to_accept_offer: "Échec de l'acceptation de l'offre.",
    failed_to_reject_offer: "Échec du refus de l'offre.",
    error_accepting_offer: "Une erreur est survenue lors de l'acceptation de l'offre.",
    error_rejecting_offer: "Une erreur est survenue lors du refus de l'offre.",
